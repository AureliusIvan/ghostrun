...
export const BGIMAGES = [candybg, candybg2, candybg3, foodbg, foodbg2, foodbg3,

]


const initialState = {
  bgColor: "pink", bg1: candybg, bg2: candybg2, bg3: candybg3,
};

const backgroundSlice = createSlice({
  name: "background", initialState, reducers: {
